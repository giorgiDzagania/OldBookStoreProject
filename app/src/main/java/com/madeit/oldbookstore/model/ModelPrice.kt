...
class ModelPrice {
    ...
    constructor(
        price: String?, book_title: String?, description: String?, location: String?,
        userID: String?, category: String?, imageUriMain: String?, imageUriFront: String?, imageUriBack: String?
    ) {
        this.price = price
