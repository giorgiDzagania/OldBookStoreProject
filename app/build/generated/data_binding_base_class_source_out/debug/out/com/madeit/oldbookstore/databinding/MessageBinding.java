...
public final class MessageBinding implements ViewBinding {
  ...
  private MessageBinding(@NonNull ConstraintLayout rootView, @NonNull CardView from,
      @NonNull Guideline guideline, @NonNull CardView to, @NonNull TextView txtFrom,
      @NonNull TextView txtTo) {
  ...
  public static MessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.from;
      CardView from = ViewBindings.findChildViewById(rootView, id);
      if (from == null) {
        break missingId;
      }
      ...
      id = R.id.to;
      CardView to = ViewBindings.findChildViewById(rootView, id);
      if (to == null) {
        break missingId;
      }
      ...
      return new MessageBinding((ConstraintLayout) rootView, from, guideline, to, txtFrom, txtTo);
    }
