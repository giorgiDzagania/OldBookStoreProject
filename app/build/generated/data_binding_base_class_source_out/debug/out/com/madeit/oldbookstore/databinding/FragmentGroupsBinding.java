...
public final class FragmentGroupsBinding implements ViewBinding {
  ...
  private FragmentGroupsBinding(@NonNull RelativeLayout rootView, @NonNull ListView listView) {
  ...
  public static FragmentGroupsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGroupsBinding((RelativeLayout) rootView, listView);
    }
